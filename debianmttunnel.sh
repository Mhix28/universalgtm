...
#Database Details
HOST='66.45.234.10';
USER='mttunnel_mttpanel';
PASS='@panelmtt@';
DBNAME='mttunnel_mttpanel';
...
def main(host=IP, port=PORT):
    print "\033[0;34m鈹�"*8,"\033[1;32m PROXY SOCKS","\033[0;34m鈹�"*8,"\n"
    print "\033[1;33mIP:\033[1;32m " + IP
    print "\033[1;33mPORTA:\033[1;32m " + str(PORT) + "\n"
    print "\033[0;34m鈹�"*10,"\033[1;32m FIRENETDEV","\033[0;34m鈹乗033[1;37m"*11,"\n"
